...
Notre **base de données principale** traitera  des **entreprises manchoises**, leurs types, leurs localisations, les différents contrats de travail qu'elles proposent ... 
<br>
...
Par ailleurs, le **tourisme occupe une place plus que significative dans ce territoire.**\
